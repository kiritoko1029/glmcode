    ...
    pub fn get_cometix() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_cometix::decode_speed_segment(),
    ...
    pub fn get_default() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_default::decode_speed_segment(),
    ...
    pub fn get_minimal() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_minimal::decode_speed_segment(),
    ...
    pub fn get_gruvbox() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_gruvbox::decode_speed_segment(),
    ...
    pub fn get_nord() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_nord::decode_speed_segment(),
    ...
    pub fn get_powerline_dark() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_dark::decode_speed_segment(),
    ...
    pub fn get_powerline_light() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_light::decode_speed_segment(),
    ...
    pub fn get_powerline_rose_pine() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_rose_pine::decode_speed_segment(),
    ...
    pub fn get_powerline_tokyo_night() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_tokyo_night::decode_speed_segment(),

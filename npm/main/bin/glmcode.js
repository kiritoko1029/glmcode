...
// 1. Priority: Use ~/.claude/glmcode/glmcode if exists
const claudePath = path.join(
  os.homedir(),
  '.claude',
  'glmcode',
  process.platform === 'win32' ? 'glmcode.exe' : 'glmcode'
);
...
if (!packageName) {
  ...
  console.error('Please visit https://github.com/kiritoko1029/glmcode for manual installation');
  process.exit(1);
}
